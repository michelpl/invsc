 ...
 */
function invsc_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Invsc default saturation level.
	 *
	 * @since Invsc 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'invsc_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.invsc-front-page) .entry-title,
...
.colors-custom .invsc-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.invsc-front-page .panel-content .recent-posts article,
...
.colors-custom.invsc-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Invsc custom colors CSS.
	 *
	 * @since Invsc 1.0
	 *
	 ...
	 */
	return apply_filters( 'invsc_custom_colors_css', $css, $hue, $saturation );
}
